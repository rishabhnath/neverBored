            ...
            <div className="fade-animation">
                ...
                <div style={{ padding: "7%" }}>
                    ...
                    <div className="row mt-3">
                        <button style={{ border: "0px", fontSize: "13px", width: "100%", padding: "12px", backgroundColor: "#F6F6F6", color: "#2D9B63", borderRadius: "16px" }}>Create new Activity</button>
                    </div>
                    <div className="row mt-3">
                        <div className="col">
                            <p>Activities</p>
                                            ...
                                            <div className="row">
                                                ...
                                                <div className="col-12" >
                                                    <div className="row" style={{ columnGap: "12px" }} >
                                                        <div className="col-2.6" style={{ marginLeft: "12px" }}>
                                                            <p><img src={star1}></img>22</p>
                                                        </div>
                                                        <div className="col-2.6 p-0">
                                                            <p><img src={Eye}></img> 12</p>
                                                        </div>
                                                        <div className="col-2.6 p-0">
                                                            <p><img src={bucket}></img> 12</p>
                                                        </div>
