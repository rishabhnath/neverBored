...
function Onboarding4(data) {
    ...
    useEffect(() => {
        ...
        if (user_data.length > 0) {
            ...
            const categoriesData = user_data[0].categories.split(",");
    ...
    const onRemoveCategory = (val) => {
        console.log(val);
        const data = selectedCategories.filter((item) => item.category_name != val);
        console.log(data);
    ...
    const submit = async () => {
        ...
        const data = { group_max_size, group_min_size, age_min_preference, age_max_preference, categories: JSON.stringify(selectedCategories) };
        const type = "put";
        ...
        <>
            <div className="fade-animation">
                ...
                <div>
                    ...
                    <br />
                    <center>
                        <p style={{ fontSize: "85%" }} className="mt-5"> these can always be changed in the  user menu, under settings</p>
