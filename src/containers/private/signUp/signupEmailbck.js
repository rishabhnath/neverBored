                ...
                {/* <div className="row">
                    ...
                    <div className="col-10" style={{ marginLeft: -"13px" }}>
                        ...
                        <div className="input-group mb-2">
                            ...
                            <input onChange={(e) => email(e.target.value) } type="text" className="form-control h-auto border-left-0 login-input-right" id="inlineFormInputGroup" placeholder="example@mail.com" />
                        </div>
                    </div>
                </div> */}
